...
int main(int argc,char** argv){
    ...
    auto t0=std::chrono::steady_clock::now();uint64_t decoded=0,output=0,read_ns=0,output_ns=0,codec_ns=0;ghvc8::Profile codec_profile;std::shared_ptr<std::vector<uint8_t>> prev;
